...
import { notImplemented } from "https://deno.land/std@0.97.0/node/_utils.ts";
import EventEmitter from "https://deno.land/std@0.97.0/node/events.ts";
import { fromFileUrl } from "https://deno.land/std@0.97.0/path/mod.ts";
  ...
  get stdout() {
    return {
      ...
      write(
        ...
        _callback: (value: void) => void = () => {},
      ): void {
        writeAll(
          Deno.stdout,
          typeof _chunk === "string" ? encoder.encode(_chunk) : _chunk,
